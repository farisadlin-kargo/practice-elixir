defmodule PhoenixBasic.TransportersTest do
  use PhoenixBasic.DataCase

  alias PhoenixBasic.Transporters

  describe "transporters" do
    alias PhoenixBasic.Transporters.Transporter

    import PhoenixBasic.TransportersFixtures

    @invalid_attrs %{id: nil, name: nil, npwp_number: nil, phone_number: nil}
    ...
    test "create_transporter/1 with valid data creates a transporter" do
      valid_attrs = %{id: 42, name: "some name", npwp_number: "some npwp_number", phone_number: "some phone_number"}
    ...
    test "update_transporter/2 with valid data updates the transporter" do
      transporter = transporter_fixture()
      update_attrs = %{id: 43, name: "some updated name", npwp_number: "some updated npwp_number", phone_number: "some updated phone_number"}
